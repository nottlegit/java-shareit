...
class UserDtoTest {
    ...
    void shouldCreateUserDtoUsingBuilder() {
        ...
        assertEquals("test-email-1@test.com", dto.getEmail());
    }
    ...
    void shouldCreateUserDtoUsingToBuilder() {
        ...
        assertEquals("test-email-1@test.com", modified.getEmail());
    }
    ...
    void shouldSetAndGetFields() {
        ...
        dto.setEmail("test-email-1@test.com");
    ...
    void shouldPassValidationWithComplexEmail() {
        UserDto dto = UserDto.builder()
                .name("test-user-name-1")
                .email("test-email-1+test@subdomain.test.co.uk")
                .build();
    ...
    @Test
    void testEqualsAndHashCode_WithDifferentEmails() {
        UserDto dto1 = UserDto.builder()
                .email("test-email-1@test.com")
                .build();
    ...
    @Test
    void testEqualsAndHashCode_WithSameEmailDifferentIds() {
        UserDto dto1 = UserDto.builder()
                .id(1L)
                .email("test-email@test.com")
                .build();
