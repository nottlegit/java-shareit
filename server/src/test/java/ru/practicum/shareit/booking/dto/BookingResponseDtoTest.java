...
class BookingResponseDtoTest {
    ...
    void shouldCreateBookingResponseDtoUsingConstructor() {
        ...
        BookingResponseDto dto = new BookingResponseDto(1L, now, now.plusDays(1),
    ...
    void testEqualsAndHashCode() {
        LocalDateTime now = LocalDateTime.now().withNano(0);
        UserDto booker1 = UserDto.builder().id(1L).build();
        UserDto booker2 = UserDto.builder().id(2L).build();
        ItemDto item1 = ItemDto.builder().id(1L).build();
        ItemDto item2 = ItemDto.builder().id(2L).build();
    ...
    void testCanEqual() {
        LocalDateTime now = LocalDateTime.now().withNano(0);
        BookingResponseDto dto1 = BookingResponseDto.builder().id(1L).build();
        BookingResponseDto dto2 = BookingResponseDto.builder().id(1L).build();
